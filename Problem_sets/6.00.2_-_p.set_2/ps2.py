...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.cleaned = [[0 for i in range(width)] for row in range(height)]
        self.clean_count = 0
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        if self.cleaned[math.floor(pos.getY())][math.floor(pos.getX())] == 0:
            self.cleaned[math.floor(pos.getY())][math.floor(pos.getX())] = 1
            self.clean_count += 1
        else:
            pass
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        if self.cleaned[math.floor(n)][math.floor(m)]:
            return True
        else:
            return False
    ...
    def getRandomPosition(self):
        ...
        """
        x = random.randrange(0, self.getWidth())
        y = random.randrange(0, self.getHeight())
        pos = Position(x, y)
        return pos
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        if 0 <= pos.getX() < self.getWidth() and 0 <= pos.getY() < self.getHeight():
            return True
        else:
            return False
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for trial in range(num_trials):
        ...
        while room.getNumCleanedTiles() / room.getNumTiles() < min_coverage:
            # anim.update(room, [robot for robot in robots.values()])
